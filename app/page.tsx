    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-blue-50 relative">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
              Join groups of like-minded students who collaborate and create
              projects, then show off your skills in our competitions!
            </p>
            <a
              href="https://docs.google.com/forms/d/e/1FAIpQLSdlmr3sPk-aGvsA940uYbndY_ZR9iH-WaJgFvDQtCg8A70oVA/viewform"
      ...
      <section className="relative z-10 px-6 py-16 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="text-center p-6 border border-gray-200 rounded-lg bg-white/50 backdrop-blur-sm">
            ...
            <p className="text-gray-600">Find us in Room 105 (Mr. McTimoney)</p>
          </div>
          <div className="text-center p-6 border border-gray-200 rounded-lg bg-white/50 backdrop-blur-sm">
      ...
      <section className="relative z-10 px-6 py-16 max-w-7xl mx-auto text-center">
        ...
        <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
          Get access to a personal member bio website to advertise your new
          skills for internships and more.
        </p>
        <a
          href="https://docs.google.com/forms/d/e/1FAIpQLSdlmr3sPk-aGvsA940uYbndY_ZR9iH-WaJgFvDQtCg8A70oVA/viewform"
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-600 leading-relaxed">
              Dive into tech projects, brainstorm with friends, and bring ideas
              to life.
            </p>
          </div>
          <div className="text-center">
            <h3 className="text-xl font-bold text-gray-800 mb-3">
              Assistance on Schoolwork
            </h3>
            <p className="text-gray-600 leading-relaxed">
              Support for coding tasks and tech projects to make coursework
              easier.
            </p>
          </div>
          <div className="text-center">
          ...
          <div className="text-center">
            <h3 className="text-xl font-bold text-gray-800 mb-3">
              Expansive Competitions
            </h3>
            <p className="text-gray-600 leading-relaxed">
              Hackathons and coding challenges across the county—show your
              skills and meet other enthusiasts.
            </p>
          </div>
        </div>
      </section>
