    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-blue-50 relative">
      ...
      <section className="relative z-10 px-6 py-16 max-w-7xl mx-auto text-center mt-20">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Meet the talented students who make CSSS a vibrant community of
      ...
      <section className="relative z-10 px-6 py-16 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {members.map((member) => (
            <div
              key={member.id}
              className="bg-white/50 backdrop-blur-sm rounded-lg p-6 border border-gray-200 hover:shadow-md transition-shadow"
            >
      ...
      <section className="relative z-10 px-6 py-16 max-w-7xl mx-auto text-center">
        ...
        <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
          Become part of our growing community and showcase your skills
          alongside these talented members.
        </p>
        <a
